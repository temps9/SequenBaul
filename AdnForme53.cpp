    ...
    for(int laforcebbase = maforceh; laforcebbase > 0; laforcebbase--)
     {
           ...
           for(int laforcebbaseb = maforceb; laforcebbaseb > 0; laforcebbaseb--)
        {

         mesamplifront[0] += quelpiano6;
         mesamplifront[1] += quelpiano7;
...
// il faut faire attention selon monté, descente, ou plateau ce sont des équilibres différents donc des sons différents
    ...
    for(int pourquelpiano13 = quelpiano13; pourquelpiano13 > 0; pourquelpiano13--)
     {
